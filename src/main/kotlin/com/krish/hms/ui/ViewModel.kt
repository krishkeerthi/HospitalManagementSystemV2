...
import com.krish.hms.helper.getDefaultTime
import com.krish.hms.helper.getDoctorSelection
import com.krish.hms.helper.getPatientSelection
...
class ViewModel(val uiHandler: UIHandler) : Modules {
    ...
    override fun addDoctor() {
        ...
        if(!hmsRepository.doctorRepository.checkDoctorExistence(ssn)){
            ...
            uiHandler.writeData("Doctor is already working here", LogLevel.WARNING)
    }
    ...
    override fun addPatient() {
        ...
        val inTime = uiHandler.readTime("patient in") ?: getDefaultTime().
    ...
    override fun listDoctors() {
        ...
        if(doctors != null && doctors.isNotEmpty()){
            ...
            uiHandler.writeData("No data found", LogLevel.ERROR)
    }
    ...
    override fun listCases() {
        ...
        if(case == null)
            return uiHandler.writeData("Case does not exist", LogLevel.ERROR)
        else{
        ...
        if(consultations == null)
            return uiHandler.writeData("No consultations available", LogLevel.ERROR)
        else{
            for(consultationId in consultations){
                ...
                if(consultation != null){
                    ...
                    if(medicines != null){
                        ...
                        uiHandler.writeData("No medicine available for this consultation", LogLevel.WARNING)
                }
            }
        }
    }
